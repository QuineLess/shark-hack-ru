...
constexpr int LinearCongruentGenerator(int Rounds) {
	return /*1013904223*/4913544289 + 3612506 /*1664525*/ * ((Rounds > 0) ? LinearCongruentGenerator(Rounds - 1) : compile_seed & 0xFFFFFFFF);
}

#define get_random() EnsureCompileTime<LinearCongruentGenerator(10)>::Value //10 Rounds
#define get_random_number(Min, Max) (Min + (get_random() % (Max - Min + 1)))
...
private:
	...
	static const Char XORKEY = static_cast<Char>(get_random_number(0, 0xFFFF));
