...
std::unordered_map<ImGuiID, float> checkbox_pos;
std::unordered_map<ImGuiID, float> combo_animation;
std::unordered_map<ImGuiID, float> slider_radius;;
std::unordered_map<ImGuiID, float> button_alpha_hovered;

void ImGui::Anim(float* pAnim, bool IsTrue, float min, float max, float strong, float strong2)
{
	if (max > min)
	{
		if (IsTrue)
		{
			if (*pAnim < max && strong)
				*pAnim += strong * ImGui::GetIO().DeltaTime;
			if (*pAnim > max || !strong)
				*pAnim = max;
		}
		else
		{
			if (*pAnim > min && strong2)
				*pAnim -= strong2 * ImGui::GetIO().DeltaTime;
			if (*pAnim < min || !strong2)
				*pAnim = min;
		}
	}
...
bool ImGui::Button(const char* label, const ImVec2& size_arg)
{
	...
	bool hovered = ItemHoverable(bb, id);
	auto alpha_hovered = &button_alpha_hovered[id];
	Anim(alpha_hovered, hovered, 0.f, 65.f, 260.f, 260.f);

	window->DrawList->AddRectFilledMultiColor({ bb.Min.x, bb.Max.y - 3.f }, { bb.Max.x, bb.Max.y + 3.f }, ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 80.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 80.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)));

	auto color = ColorConvertU32ToFloat4(GetColorU32(ImGuiCol_Button));
	PushStyleColor(ImGuiCol_ButtonHovered, ImGui::ColConvertToFloat(color.x * 255.f, color.y * 255.f, color.z * 255.f, color.w * 255.f - *alpha_hovered));
...
bool ImGui::ButtonSubtabs(const char* label, const ImVec2& size_arg, bool selected)
{
	ImGuiContext& g = *GImGui;
	...
	ImVec2 size = CalcItemSize(size_arg, label_size.x + g.Style.FramePadding.x * 2.0f, label_size.y + g.Style.FramePadding.y * 2.0f);
	...
	auto alpha_hovered = &button_alpha_hovered[id];
	Anim(alpha_hovered, hovered, 0.f, 105.f, 260.f, 260.f);

    const ImU32 col = GetColorU32(selected ? (held && hovered) ? ColConvertToFloat(74.f, 156.f, 239.f, 170.f) : hovered ? ColConvertToFloat(74.f, 156.f, 239.f, 255.f - *alpha_hovered) : ColConvertToFloat(74.f, 156.f, 239.f) : (held && hovered) ? ColConvertToFloat(28.f, 50.f, 74.f, 170.f) : hovered ? ColConvertToFloat(28.f, 50.f, 74.f, 255.f - *alpha_hovered) : ColConvertToFloat(28.f, 50.f, 74.f));
    window->DrawList->AddRectFilled(bb.Min, bb.Max, col, g.Style.FrameRounding);

	return pressed;
}

bool ImGui::ButtonTabs(const char* label, const ImVec2& size_arg, bool selected)
{
	ImGuiWindow* window = GetCurrentWindow();
	ImGuiContext& g = *GImGui;
	const ImGuiID id = window->GetID(label);
    ...
    PushStyleColor(ImGuiCol_Text, ColConvertToFloat(101.f, 129.f, 166.f, 0.f));
    PushStyleColor(ImGuiCol_Button, ColConvertToFloat(37.f, 62.f, 93.f));
    PushStyleColor(ImGuiCol_ButtonHovered, ColConvertToFloat(37.f, 62.f, 93.f, 255.f - *alpha_hovered));
    PushStyleColor(ImGuiCol_ButtonActive, ColConvertToFloat(37.f, 62.f, 93.f, 170.f));
...
bool ImGui::ComboButton(const char* label, const ImVec2& size_arg, bool selected)
{
	ImGuiContext& g = *GImGui;
	ImGuiWindow* window = g.CurrentWindow;
	const ImGuiID id = window->GetID(label);
    ...
    const ImU32 col = GetColorU32(selected ? (held && hovered) ? ColConvertToFloat(74.f, 156.f, 239.f, 170.f) : hovered ? ColConvertToFloat(74.f, 156.f, 239.f, 255.f - *alpha_hovered) : ColConvertToFloat(74.f, 156.f, 239.f) : (held && hovered) ? ColConvertToFloat(28.f, 50.f, 74.f, 170.f) : hovered ? ColConvertToFloat(28.f, 50.f, 74.f, 255.f - *alpha_hovered) : ColConvertToFloat(28.f, 50.f, 74.f));
    window->DrawList->AddRectFilled(bb.Min, bb.Max, col, g.Style.ChildRounding);
	RenderText(bb.Min + ImVec2(g.Style.FramePadding.x, ((bb.Max.y - bb.Min.y) / 2.f) - (label_size.y / 2.f)), label, NULL, &label_size);

	return pressed;
}

bool ImGui::CheckboxButton(const char* label, const ImVec2& size_arg, bool* v)
{
	ImGuiWindow* window = GetCurrentWindow();
	if (window->SkipItems)
		return false;
    ...
    const ImU32 col = GetColorU32(*v ? (held && hovered) ? ColConvertToFloat(74.f, 156.f, 239.f, 170.f) : hovered ? ColConvertToFloat(74.f, 156.f, 239.f, 255.f - *alpha_hovered) : ColConvertToFloat(74.f, 156.f, 239.f) : (held && hovered) ? ColConvertToFloat(28.f, 50.f, 74.f, 170.f) : hovered ? ColConvertToFloat(28.f, 50.f, 74.f, 255.f - *alpha_hovered) : ColConvertToFloat(28.f, 50.f, 74.f));
    window->DrawList->AddRectFilled(bb.Min, bb.Max, col, g.Style.ChildRounding);
	RenderText(bb.Min + ImVec2(g.Style.FramePadding.x, ((bb.Max.y - bb.Min.y) / 2.f) - (label_size.y / 2.f)), label, NULL, &label_size);
...
bool ImGui::CheckboxButtonBar(const char* label, const ImVec2& size_arg, bool* v)
{
	ImGuiWindow* window = GetCurrentWindow();
	if (window->SkipItems)
		return false;
    ...
    window->DrawList->AddRectFilled(bb.Min, bb.Max, GetColorU32(ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), g.Style.ChildRounding);
    const ImU32 col = GetColorU32(*v ? (held && hovered) ? ColConvertToFloat(255.f, 255.f, 255.f, 170.f) : hovered ? ColConvertToFloat(255.f, 255.f, 255.f, 255.f - *alpha_hovered) : ColConvertToFloat(255.f, 255.f, 255.f) : (held && hovered) ? ColConvertToFloat(255.f, 255.f, 255.f, 170.f) : hovered ? ColConvertToFloat(255.f, 255.f, 255.f, 255.f - *alpha_hovered) : ColConvertToFloat(255.f, 255.f, 255.f));
    PushStyleColor(ImGuiCol_Text, col);
	PushFont(roboto_bold_elements);
	RenderText(bb.Min + ImVec2(g.Style.FramePadding.x, ((bb.Max.y - bb.Min.y) / 2.f) - (label_size.y / 2.f)), label, NULL, &label_size);
	PopFont();
	PopStyleColor();
...
bool ImGui::ListButton(const char* label, const ImVec2& size_arg, bool selected)
{
	ImGuiContext& g = *GImGui;
	ImGuiWindow* window = g.CurrentWindow;
	const ImGuiID id = window->GetID(label);
    ...
    const ImU32 col = GetColorU32(selected ? (held && hovered) ? ColConvertToFloat(74.f, 156.f, 239.f, 170.f) : hovered ? ColConvertToFloat(74.f, 156.f, 239.f, 255.f - *alpha_hovered) : ColConvertToFloat(74.f, 156.f, 239.f) : (held && hovered) ? ColConvertToFloat(37.f, 62.f, 93.f, 170.f) : hovered ? ColConvertToFloat(37.f, 62.f, 93.f, 255.f - *alpha_hovered) : ColConvertToFloat(37.f, 62.f, 93.f));
    window->DrawList->AddRectFilled(bb.Min, bb.Max, col, g.Style.ChildRounding);
	RenderText(bb.Min + ImVec2(g.Style.FramePadding.x, ((bb.Max.y - bb.Min.y) / 2.f) - (label_size.y / 2.f)), label, NULL, &label_size);
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    float item_padding = 20.f;
    float item_spacing = style.ItemInnerSpacing.x;

    const ImRect check_bb(ImVec2(window->DC.CursorPos.x, window->DC.CursorPos.y), window->DC.CursorPos + ImVec2(window->Size.x - item_padding, label_size.y + style.FramePadding.y * 2));
	const ImRect check_bb_pos(window->DC.CursorPos + ImVec2(window->Size.x - item_padding * 3.f, 0.f), window->DC.CursorPos + ImVec2(window->Size.x - item_padding, label_size.y + style.FramePadding.y * 2));
    ...
    bool hovered, held;
    bool pressed = ButtonBehavior(check_bb_pos, id, &hovered, &held);

	auto pos = &checkbox_pos[id];
	...
	if (*v) {
		if (!*pos)
			*pos = 100.f;
		*pos += 80.f * ImGui::GetIO().DeltaTime;
	}
	else {
		if (!*pos)
			*pos = 1;
    ...
    float item_width = item_padding * 2 + item_spacing * 2;

    window->DrawList->AddRectFilled(ImVec2(check_bb.Min.x + 5.5f + (window->Size.x - item_width), check_bb.Min.y + 4), ImVec2(check_bb.Min.x + 36.5f + (window->Size.x - item_width), check_bb.Min.y + 16), GetColorU32(ImGuiCol_CheckboxFrame), 10.f);
    window->DrawList->AddRectFilled(ImVec2(check_bb.Min.x + 5.5f + (window->Size.x - item_width), check_bb.Min.y + 4), ImVec2(check_bb.Min.x + *pos + 8.5f + (window->Size.x - item_width), check_bb.Min.y + 16), GetColorU32(ImGuiCol_CheckboxFrameActive), 10.f);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + *pos + (window->Size.x - item_width) - style.ShadowSize.x, check_bb.Min.y + 10.2f + style.ShadowSize.y), 9, GetColorU32(ImGuiCol_Shadow), 28);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + *pos + (window->Size.x - item_width), check_bb.Min.y + 10.2f), 9, GetColorU32(ImGuiCol_Checkbox), 28);

    PushFont(roboto_regular_checkbox);
    PushStyleColor(ImGuiCol_Text, ColConvertToFloat(235.f, 235.f, 235.f));
    if (label_size.x > 0.0f)
        RenderText(check_bb.GetTL() + ImVec2(0, label_size.y / 4.f), label);
    PopStyleColor();
    PopFont();
...
bool ImGui::RadioButton(const char* label, bool active)
{
    ...
    if (active)
    {
        ...
        window->DrawList->AddCircleFilled(center, radius - pad, GetColorU32(ImGuiCol_Checkbox), 16);
    }
...
bool ImGui::Hotkey(const char* label, int* k)
{
	...
	const ImRect frame_bb(window->DC.CursorPos, window->DC.CursorPos + ImVec2(expected_w, label_size.y + (style.FramePadding.y + 5.f) * 2.0f));
	const ImRect total_bb(frame_bb.Min, frame_bb.Max + ImVec2(label_size.x > 0.0f ? style.ItemInnerSpacing.x + label_size.x : 0.0f, 0.0f));
	ItemSize(total_bb, style.FramePadding.y + 5.f);
	...
	ImU32 rect_col = g.ActiveId == id ? GetColorU32(ImGuiCol_Button) : GetColorU32(ColConvertToFloat(235.f, 235.f, 235.f));
	window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, rect_col, style.FrameRounding, ImDrawCornerFlags_All, g.ActiveId == id ? 1.7f : 1.f);
	if (label_size.x > 0) {
		PushStyleColor(ImGuiCol_Text, rect_col);
		window->DrawList->AddLine(frame_bb.Min + ImVec2(8.f, 0), frame_bb.Min + ImVec2(16.f + label_size.x, 0), GetColorU32(ImGuiCol_ChildBg), 3.f);
		RenderText(ImVec2(frame_bb.Min.x + 13.f, frame_bb.Min.y - 8.f), label);
		PopStyleColor();
	}

	RenderTextClipped(frame_bb.Min + style.FramePadding + ImVec2(0.f, 5.f), frame_bb.Max, buf_display, NULL, NULL, ImVec2(0.0f, 0.0f));
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
	...
	const ImRect frame_bb(window->DC.CursorPos, window->DC.CursorPos + ImVec2(w, label_size.y + (style.FramePadding.y + 5.f) * 2.0f));
	const ImRect total_bb(frame_bb.Min, frame_bb.Max + ImVec2(label_size.x > 0.0f ? style.ItemInnerSpacing.x + label_size.x : 0.0f, 0.0f));
	ItemSize(total_bb, style.FramePadding.y + 5.f);
	if (!ItemAdd(total_bb, id, &frame_bb))
		return false;
	...
	const ImU32 frame_col = GetColorU32(ImGuiCol_ChildBg);
	...
	{
		ImU32 text_col = popup_open ? GetColorU32(ImGuiCol_CheckboxFrameActive) : GetColorU32(ImGuiCol_Text);
		...
		if (value_x2 + arrow_size - style.FramePadding.x <= frame_bb.Max.x)
			RenderArrow(window->DrawList, ImVec2(value_x2 + style.FramePadding.y, frame_bb.Min.y + style.FramePadding.y + 5.f), text_col, popup_open, 1.0f);
	}

	ImU32 rect_col = popup_open ? GetColorU32(ImGuiCol_CheckboxFrameActive) : GetColorU32(ColConvertToFloat(235.f, 235.f, 235.f));
	window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, rect_col, style.FrameRounding, ImDrawCornerFlags_All, popup_open ? 1.7f : 1.f);
	if (label_size.x > 0) {
		PushStyleColor(ImGuiCol_Text, rect_col);
		if (popup_open || preview_value != NULL) {
			window->DrawList->AddLine(frame_bb.Min + ImVec2(8.f, 0), frame_bb.Min + ImVec2(16.f + label_size.x, 0), GetColorU32(ImGuiCol_ChildBg), 3.f);
			PushFont(roboto_bold_elements);
			RenderText(ImVec2(frame_bb.Min.x + 13.f, frame_bb.Min.y - 8.f), label);
			PopFont();
			...
			RenderTextClipped({ frame_bb.Min.x + style.FramePadding.x, frame_bb.Min.y + style.FramePadding.y + 5.f }, ImVec2(value_x2, frame_bb.Max.y), label, NULL, NULL, ImVec2(0.0f, 0.0f));
		PopStyleColor();
	}

	if (preview_value != NULL && !(flags & ImGuiComboFlags_NoPreview))
		RenderTextClipped(frame_bb.Min + style.FramePadding + ImVec2(0.f, 5.f), ImVec2(value_x2, frame_bb.Max.y), preview_value, NULL, NULL, ImVec2(0.0f, 0.0f));
	...
	auto anim = &combo_animation[id];
	Anim(anim, popup_open, 0.f, g.Style.ComboButtonSize.y * 5.f, g.Style.ComboButtonSize.y * 20.f, 9999.f);
	...
	else
	{
		...
		SetNextWindowSizeConstraints(ImVec2(w, 0.0f), ImVec2(FLT_MAX, *anim));
	}
	...
	if (ImGuiWindow* popup_window = FindWindowByName(name))
		if (popup_window->WasActive)
		{
			...
			SetNextWindowPos(ImVec2(frame_bb.Min.x, frame_bb.Max.y + 2.5f));
		}

	// We don't use BeginPopupEx() solely because we have a custom name string, which we could make an argument to BeginPopupEx()
	ImGuiWindowFlags window_flags = (*anim == g.Style.ComboButtonSize.y * 5.f)  ? (ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_Popup | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoMove) : (ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_Popup | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoScrollbar);
...
bool ImGui::Combo(const char* label, int* current_item, bool(*items_getter)(void*, int, const char**), void* data, int items_count, int popup_max_height_in_items)
{
	...
	for (int i = 0; i < items_count; i++)
	{
		...
		if (ComboButton(item_text, g.Style.ComboButtonSize + ImVec2(window->DC.ItemWidth, 0), item_selected)) {
			item_selected;
			value_changed = true;
			*current_item = i;
			CloseCurrentPopup();
...
bool ImGui::DragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format, float power)
{
    ...
    const ImU32 frame_col = GetColorU32(g.ActiveId == id ? ColConvertToFloat(65.f, 121.f, 280.f, 210.f) : g.HoveredId == id ? ColConvertToFloat(65.f, 121.f, 280.f, 255.f - *alpha_hovered) : ColConvertToFloat(65.f, 121.f, 280.f));
    RenderNavHighlight(frame_bb, id);
...
std::unordered_map<ImGuiID, float> text_alpha;
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, float power)
{
	...
	const ImVec2 label_size = CalcTextSize(label, NULL, true);
	const ImRect frame_bb(window->DC.CursorPos, window->DC.CursorPos + ImVec2(w, label_size.y + (style.FramePadding.y + 3.5f) * 2.0f));
	const ImRect total_bb(frame_bb.Min, frame_bb.Max + ImVec2(label_size.x > 0.0f ? style.ItemInnerSpacing.x + label_size.x : 0.0f, 0.0f));

	ItemSize(frame_bb, style.FramePadding.y + 3.5f);
	if (!ItemAdd(total_bb, id, &frame_bb))
		return false;
	...
	auto radius = &slider_radius[id];
	Anim(radius, g.ActiveId == id, 6.5f, 8.f, 15.f, 15.f);

	window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, style.FramePadding.y + size + label_size.y - 1.8f), ImVec2(frame_bb.Max.x, frame_bb.Min.y + style.FramePadding.y + size + label_size.y + 1.8f), GetColorU32(ImGuiCol_FrameBg), 10.f);

	// Render grab
	if (grab_bb.Max.x > grab_bb.Min.x) {
		window->DrawList->PushClipRectFullScreen();
		window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, style.FramePadding.y + size + label_size.y - 1.8f), ImVec2(grab_bb.Max.x, frame_bb.Min.y + style.FramePadding.y + size + label_size.y + 1.8f), GetColorU32(ImGuiCol_SliderGrab), 10.f);
		window->DrawList->AddCircleFilled(ImVec2(grab_bb.Min.x - style.ShadowSize.x, frame_bb.Min.y + (style.FramePadding.y + size) + style.ShadowSize.y + label_size.y), *radius, GetColorU32(ImGuiCol_Shadow), 21);
		window->DrawList->AddCircleFilled(ImVec2(grab_bb.Min.x, frame_bb.Min.y + (style.FramePadding.y + size) + label_size.y), *radius, GetColorU32(ImGuiCol_Checkbox), 21);
		window->DrawList->PopClipRect();
	}
	// Display value using user-provided display format so user can add prefix/suffix/decorations to the value.

	PushStyleColor(ImGuiCol_Text, ColConvertToFloat(189.f, 189.f, 189.f));
	if (label_size.x > 0.0f)
	...
	auto TextAlpha = &text_alpha[id];
	Anim(TextAlpha, hovered || g.ActiveId == id, 0.f, 1.f, 10.f, 4.f);

	ImVec4 cFrameBg = ImGui::GetStyleColorVec4(ImGuiCol_Button);
	cFrameBg.w = *TextAlpha;
	ImVec4 cText = ImGui::GetStyleColorVec4(ImGuiCol_Text);
	cText.w = *TextAlpha;

	window->DrawList->PushClipRectFullScreen();
	window->DrawList->AddRectFilled(ImVec2(grab_bb.Min.x - CalcTextSize(value_buf, NULL, true).x / 2 - (g.FontSize / 2.f), grab_bb.Min.y + ((grab_bb.Max.y - grab_bb.Min.y) / 2) - (g.FontSize / 14.f) * 16), ImVec2(CalcTextSize(value_buf, NULL, true).x + (g.FontSize / 2.f) + grab_bb.Min.x - CalcTextSize(value_buf, NULL, true).x / 2, CalcTextSize(value_buf, NULL, true).y + grab_bb.Min.y + ((grab_bb.Max.y - grab_bb.Min.y) / 2) - (g.FontSize / 14.f) * 16), GetColorU32(cFrameBg), (g.FontSize / 14.f) * g.Style.FrameRounding);
	window->DrawList->AddText(ImVec2(grab_bb.Min.x - CalcTextSize(value_buf, NULL, true).x / 2, grab_bb.Min.y + ((grab_bb.Max.y - grab_bb.Min.y) / 2) - (g.FontSize / 14.f) * 16), GetColorU32(cText), value_buf, value_buf_end);
	window->DrawList->PopClipRect();
...
bool ImGui::InputScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_step, const void* p_step_fast, const char* format, ImGuiInputTextFlags flags)
{
    ...
    if (p_step != NULL)
    {
        const float button_size = GetFrameHeight() + 9.5f;
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    const ImGuiID id = window->GetID(label);
    const ImVec2 label_size = CalcTextSize(label, NULL, true);
    const ImVec2 frame_size = CalcItemSize(size_arg, CalcItemWidth(), (is_multiline ? g.FontSize * 8.0f : label_size.y) + (style.FramePadding.y + 5.f) *2.0f); // Arbitrary default of 8 lines high for multi-line
    ...
    if (g.ActiveId == id)
    {
        ...
        const float mouse_y = (is_multiline ? (io.MousePos.y - draw_window->DC.CursorPos.y - (style.FramePadding.y + 5.f)) : (g.FontSize*0.5f));
    ...
    {
        RenderNavHighlight(frame_bb, id);
		window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, g.ActiveId == id ? GetColorU32(ImGuiCol_CheckboxFrameActive) : GetColorU32(ColConvertToFloat(235.f, 235.f, 235.f)), style.FrameRounding, ImDrawCornerFlags_All, g.ActiveId == id ? 1.7f : 1.f);
		if (label_size.x > 0) {
			PushStyleColor(ImGuiCol_Text, g.ActiveId == id ? GetColorU32(ImGuiCol_Button) : GetColorU32(ColConvertToFloat(235.f, 235.f, 235.f)));
			window->DrawList->AddLine(frame_bb.Min + ImVec2(8.f, 0), frame_bb.Min + ImVec2(16.f + label_size.x, 0), GetColorU32(ImGuiCol_ChildBg), 3.f);
			PushFont(roboto_bold_elements);
			RenderText(ImVec2(frame_bb.Min.x + 13.f, frame_bb.Min.y - 8.f), label);
			PopStyleColor();
    ...
    ImVec2 draw_pos = is_multiline ? draw_window->DC.CursorPos : frame_bb.Min + style.FramePadding + ImVec2(0.f, 5.f);
...
bool ImGui::ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags, ImVec2 size)
{
    ...
    if (size.y == 0.0f)
        size.y = default_size;
    const ImRect bb(window->DC.CursorPos + ImVec2(2.f, 2.f), window->DC.CursorPos + size - ImVec2(2.f, 2.f));
	...
	auto alpha_hovered = &button_alpha_hovered[id];
	Anim(alpha_hovered, hovered, 0.f, 90.f, 400.f, 400.f);
	window->DrawList->AddRectFilled(bb_inner.Min - ImVec2(1.f, 1.f), bb_inner.Max + ImVec2(1.f, 1.f), GetColorU32(ImGui::ColConvertToFloat(37.f, 62.f, 93.f, 90.f - *alpha_hovered)), rounding, ImDrawCornerFlags_All);
