...
ImVec4 ImGui::ColConvertToFloat(float r, float g, float b, float a) { 
...
void ImGui::RenderArrow(ImDrawList* draw_list, ImVec2 pos, ImU32 col, bool dir, float scale)
{
	...
	ImVec2 a = ImVec2(0.f, 0.4f) * r;
	ImVec2 b = ImVec2(-0.6f, -0.4f) * r;
	ImVec2 c = ImVec2(0.6f, -0.4f) * r;
...
void ImGui::UpdateMouseWheel()
{
    ...
    static auto SetWindowScrollY = [](ImGuiWindow* window, float scroll_y) {
        ImGuiContext& g = *GImGui;
    ...
    const float scroll_speed = ImFloor(window->CalcFontSize() * 100.f * g.IO.DeltaTime + 0.5f);

    if (*g.IO.MouseDownDuration < 0.1f) {
       ...
       float scroll_step = ImFloor(ImMin(8.f * window->CalcFontSize(), (scroll_window->ContentRegionRect.GetHeight() + g.IO.DeltaTime * 2.0f) * 0.67f));
...
void ImGui::Render(ImDrawList* draw_list)
{
	ImGuiContext& g = *GImGui;
	IM_ASSERT(g.Initialized);
	...
	if (draw_list && !draw_list->VtxBuffer.empty())
		AddDrawListToDrawData(&g.DrawDataBuilder.Layers[0], draw_list);
...
ImVec4 ColConvert(float r, float g, float b, float a = 255.f) { return ImVec4(r / 255.f, g / 255.f, b / 255.f, a / 255.f); }
...
bool ImGui::BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
	...
	if (!(flags & ImGuiWindowFlags_NoChildShadow)) {
		if (border) {
			ImDrawList* DrawList = parent_window->DrawList;

			float x = parent_window->DC.CursorPos.x;
			float y = parent_window->DC.CursorPos.y;

			DrawList->AddRectFilledMultiColor({ x, y - 3.f }, { x + size_arg.x, y }, ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)));
			DrawList->AddRectFilledMultiColor({ x, y + size_arg.y }, { x + size_arg.x, y + size_arg.y + 7.f }, ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)));
			DrawList->AddRectFilledMultiColor({ x + size_arg.x, y }, { x + size_arg.x + 7.f, y + size_arg.y }, ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)));
			DrawList->AddRectFilledMultiColor({ x - 3.f, y }, { x , y + size_arg.y }, ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)));
		}
		else {
			ImDrawList* DrawList = parent_window->DrawList;
			...
			DrawList->AddRectFilledMultiColor({ x, y - 3.f }, { x + size_arg.x, y }, ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)));
			DrawList->AddRectFilledMultiColor({ x, y + size_arg.y }, { x + size_arg.x, y + size_arg.y + 7.f }, ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)));
			DrawList->AddRectFilledMultiColor({ x + size_arg.x - g.Style.ScrollbarSize, y }, { x + size_arg.x - g.Style.ScrollbarSize + 7.f, y + size_arg.y }, ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)));
			DrawList->AddRectFilledMultiColor({ x - 3.f, y }, { x , y + size_arg.y }, ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 20.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)));
		}
	}
...
void ImGui::RenderWindowDecorations(ImGuiWindow* window, const ImRect& title_bar_rect, bool title_bar_is_highlight, int resize_grip_count, const ImU32 resize_grip_col[4], float resize_grip_draw_size)
{
    ...
    else
    {
        ...
        if (!(flags & ImGuiWindowFlags_NoTitleBar))
        {
            ...
            window->DrawList->AddRectFilledMultiColor({ title_bar_rect.Min.x, title_bar_rect.Max.y }, { title_bar_rect.Max.x, title_bar_rect.Max.y + 10.f }, ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 50.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 50.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)), ImGui::GetColorU32(ImGui::ColConvertToFloat(0.f, 0.f, 0.f, 0.f)));
        }
...
const char* ImGui::GetStyleColorName(ImGuiCol idx)
{
    ...
    case ImGuiCol_CheckboxFrame: return "CheckboxFrame";
    case ImGuiCol_CheckboxFrameActive: return "CheckboxFrameActive";
