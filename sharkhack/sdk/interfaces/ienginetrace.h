...
{
	Vector2D plane;               // The plane of the brush side
...
public:
	...
	CGameTrace() { }  // No copy constructors allowed
...
inline bool CGameTrace::DidHitWorld()
{
	return hit_entity && (*(int*)((uintptr_t)hit_entity + 0x64)) == 0;
}

inline bool CGameTrace::DidHitNonWorldEntity()
{
...
public:
	...
	void TraceLine( const Vector& vecSource, const Vector& vecDistance, const int nMask, IHandleEntity* pEntity, const int nCollisionGroup, CGameTrace* pTrace );
	void TraceHull( const Vector& vecSource, const Vector& vecDistance, const Vector& vecMins, const Vector& vecMaxs, const int nMask, IHandleEntity* pEntity, const int nCollisionGroup, CGameTrace* pTrace );
};