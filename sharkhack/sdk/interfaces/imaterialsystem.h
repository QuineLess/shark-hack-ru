...
public:
	std::byte pad_0[0x50];
	texture** texture_handles;

	get_virtual_fn(3, get_actual_width(), int(__thiscall*)(void*));
	get_virtual_fn(4, get_actual_height(), int(__thiscall*)(void*));
};
...
class IMatRenderContext {
public:
	get_virtual_fn(1, release(), int(__thiscall*)(void*));
	get_virtual_fn(5, bind_local_cubemap(ITexture* texture), void(__thiscall*)(void*, ITexture*), texture);
	get_virtual_fn(6, set_render_target(ITexture* texture), void(__thiscall*)(void*, ITexture*), texture);
	get_virtual_fn(12, clear_buffers(bool clear_color, bool clear_depth, bool clear_stencil), void(__thiscall*)(void*, bool, bool, bool), clear_color, clear_depth, clear_stencil);
	get_virtual_fn(40, viewport(int32_t x, int32_t y, int32_t width, int32_t height), void(__thiscall*)(void*, int32_t, int32_t, int32_t, int32_t), x, y, width, height);
	get_virtual_fn(41, get_viewport(int32_t& x, int32_t& y, int32_t& width, int32_t& height), void(__thiscall*)(void*, int32_t&, int32_t&, int32_t&, int32_t&), x, y, width, height);
	get_virtual_fn(78, clear_color_3ub(uint8_t r, uint8_t g, uint8_t b), void(__thiscall*)(void*, uint8_t, uint8_t, uint8_t), r, g, b);
	get_virtual_fn(79, clear_color_4ub(uint8_t r, uint8_t g, uint8_t b, uint8_t a), void(__thiscall*)(void*, uint8_t, uint8_t, uint8_t, uint8_t), r, g, b, a);
	get_virtual_fn(80, override_depth_enable(bool enable, bool depth_write_enable, bool depth_test_enable), void(__thiscall*)(void*, bool, bool, bool), enable, depth_write_enable, depth_test_enable);
	get_virtual_fn(114, draw_screen_space_rectangle(IMaterial* material, int32_t dest_x, int32_t dest_y, int32_t width, int32_t height, float_t src_texture_x0, float_t src_texture_y0, float_t src_texture_x1, float_t src_texture_y1, int32_t src_texture_width, int32_t src_texture_height, void* client_renderable = nullptr, int32_t dice_x = 1, int32_t dice_y = 1), void(__thiscall*)(void*, IMaterial*, int32_t, int32_t, int32_t, int32_t, float_t, float_t, float_t, float_t, int32_t, int32_t, void*, int32_t, int32_t), material, dest_x, dest_y, width, height, src_texture_x0, src_texture_y0, src_texture_x1, src_texture_y1, src_texture_width, src_texture_height, client_renderable, dice_x, dice_y);
	get_virtual_fn(119, push_render_target_and_viewport(), void(__thiscall*)(void*));
	get_virtual_fn(120, pop_render_target_and_viewport(), void(__thiscall*)(void*));
	get_virtual_fn(126, set_int_rendering_parameter(int parm_number, int value), void(__thiscall*)(void*, int, int), parm_number, value);
	get_virtual_fn(144, begin_pix_event(unsigned long color, const char* name), void(__thiscall*)(void*, unsigned long, const char*), color, name);
	get_virtual_fn(145, end_pix_event(), void(__thiscall*)(void*));
	get_virtual_fn(158, set_lighting_origin(float_t x, float_t y, float_t z), void(__thiscall*)(void*, float_t, float_t, float_t), x, y, z);
};
...
public:
	...
	get_virtual_fn(115, get_render_context(), IMatRenderContext* (__thiscall*)(void*));
	get_virtual_fn(136, finish_render_target_allocation(), void(__thiscall*)(void*));
};